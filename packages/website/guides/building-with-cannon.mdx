...
<Alert variant="warning" className="mt-6">
  <AlertDescription>
    The `cannon build` uses the `cannonfile.toml` by default but you can specify which cannonfile you want to use with the `[cannonfile]` argument. You can find all the CLI commands documentation in the [CLI guide](https://usecannon.com/learn/cli).
  </AlertDescription>
</Alert>
