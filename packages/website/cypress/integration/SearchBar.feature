Feature: SearchBar function
  ...
  Scenario: Confirming the searchbar dialog
  ...
  Scenario: Searching for the namespace on the searchbar
    Given User opens the "/learn" page
    When User clicks on the 1st element with id "searchbar-button"
  ...
  Scenario: Searching for the function on the searchbar
    Given User opens the "/learn" page
    When User clicks on the 1st element with id "searchbar-button"
  ...
  Scenario: Searching for the package on the searchbar
    Given User opens the "/learn" page
    When User clicks on the 1st element with id "searchbar-button"
    * User types "syn" into the 1st input with id "sidebar-search-input"
    ...
    Then URL includes "synthetix-omnibus"
