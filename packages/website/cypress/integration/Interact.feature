Feature: Interact page
  ...
  Scenario: Executing read functions
    ...
    * User clicks on the "button" element with text "Call function"
    ...
    Then The Value Of Input has "0xffffffaEff0B96Ea8e4f94b2253f31abdD875847"
    ...
    * User clicks on the "button" element with text "Call function"
    ...
    Then The Value Of Input has "11155111"
    ...
    * User types "registry" for "getPackageOwner(bytes32)"
    * User clicks on the "button" element with text "Call function"
    # Then View renders a "div" displaying the text "0x493E75825b862c355a4263C9C1CB6F650539B328"
    Then The Value Of Input has "0x493E75825b862c355a4263C9C1CB6F650539B328"
    ...
    * User clicks on the "button" element with text "Call function"
    ...
    Then The Value Of Input has "0x012bAC54348C0E635dCAc9D5FB99f06F24136C9A"
    ...
    * User clicks on the "button" element with text "Call function"
    ...
    Then The Value Of Input has "5708990770823839524233143914701057466751846718296"
