  ...
  return (
    <>
      ...
      <p className="mb-4">
        ...
        . This can be used by defining a <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">router</code> operation in
      ...
      <p className="mb-4">
        This project will include a <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">Counter.sol</code> contract by
        ...
        contract to <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">AnotherCounter</code>.
      </p>

      <p className="mb-4">
        Create <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">cannonfile.toml</code> that deploys the two contracts and a
        router:
      </p>
      ...
      <p className="mb-4">
        ...
        <NextLink href="/search" className="text-blue-400 hover:text-blue-300 underline">
          package manager
        </NextLink>
        . Here, we add the <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">--registry-priority local</code> option to
      ...
      <p className="mb-4">
        Press <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">i</code> to interact with the contracts in this project.
      ...
      <Alert className="mb-4 bg-gray-700">
        ...
        <AlertDescription>
          <h4 className="font-semibold mb-1">Interact with the router contract</h4>
          <p>
      ...
      <p className="mb-4">
        ...
        <NextLink href="/packages/transparent-upgradable-proxy" className="text-blue-400 hover:text-blue-300 underline">
      ...
      <p className="mb-4">
        ...
        your Cannonfile and use the <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">--upgrade-from</code> option to
      ...
      <Alert className="mb-4 bg-gray-700">
        <InfoCircledIcon className="h-4 w-4" />
        <AlertDescription>
          <h4 className="font-semibold mb-1">Interact with the proxy contract</h4>
          <p>
      ...
      <p>
        ...
        , you can use the{' '}
        <NextLink href="/deploy" className="text-blue-400 hover:text-blue-300 underline">
          deployer
        </NextLink>{' '}
        to run upgrades. (
        <a
        ...
        immutable with a call to <code className="px-1.5 py-0.5 bg-gray-700 rounded text-sm">renounceOwnership</code> on the proxy.
      </p>
    </>
  );
};
