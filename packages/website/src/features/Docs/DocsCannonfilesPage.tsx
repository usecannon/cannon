  ...
  return (
    <SidebarLayout sidebarContent={sidebarContent}>
      <div className="max-w-[1024px]">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4">Cannonfile Documentation</h1>
          <p className="mb-4">
            Cannonfiles are like deployment plans. They include operations that
            specify the desired state of a blockchain. The web app and the CLI
            can be used to <code>build</code> the blockchain into this state.
            This results in a package of data pertaining to the deployment,
            which can be uploaded using IPFS and published to the registry on
            Ethereum. Deployments that upgrade from existing packages will
            recognize which operations have been completed, executing only those
          ...
          <p className="mb-4">
            Packages that result from <code>build</code>s consist of three JSON
            files, which are compressed and uploaded using IPFS:{' '}
            <a href="#deployment-data">deployment data</a>,{' '}
