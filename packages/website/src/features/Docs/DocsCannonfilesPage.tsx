      ...
      <SidebarGroup>
        ...
        <SidebarGroupContent>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild>
                <a href="#factory-deployed-contracts">Factory Contracts</a>
              </SidebarMenuButton>
            </SidebarMenuItem>
            <SidebarMenuItem>
              <SidebarMenuButton asChild>
          ...
          <div className="mb-8">
            ...
            <div className="mb-16" id="deployment-data">
              ...
              <p className="mb-4">
                ...
                package definition and on-chain state data derived changes made
                by defined steps in the cannonfile definition. Deployment data
                is stored on IPFS and is locally stored in your filesystem in
          ...
          <div className="mb-8">
            ...
            <div className="mb-16" id="factory-deployed-contracts">
              ...
              <p className="mb-4">
                ...
                contracts. Contracts which deploy others are typically referred
                to as factory contracts. You can reference contracts deployed by
...
factory.MyPoolDeployment.arg = 0`}</code>
              ...
              <p className="mb-4 mt-4">
                ...
                first data argument (per arg, a zero-based index). This contract
                should implement the Pool contract. Now, a subsequent invoke
                operation could set
              </p>
              <Snippet>
            ...
            <div className="mb-16" id="var">
              ...
              <p className="mb-4">
                ...
                lets you reference previously emitted event’s data in subsequent
                invoke operations.
              </p>
              <p className="mb-4">
...
var.NewDeploymentEvent.arg = 0
            ...
            <div className="mb-16" id="event-error-logging">
              ...
              <p className="mb-4">
                ...
                function does not emit any events or emits an event that doesn’t
                match the one specified in the cannonfile, the invoke operation
              ...
              <p className="mb-4">
                ...
                data through the contracts or settings properties if a matching
                event wasnt emitted
              </p>
            </div>
          </div>
