            ...
            <div className="container max-w-[1024px] ml-0 p-8">
              <div className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  that specify the desired state of a blockchain. The web app
                  and the CLI can be used to <code>build</code> the blockchain
                  into this state. This results in a package of data pertaining
                  to the deployment, which can be uploaded using IPFS and
                  published to the registry on Ethereum. Deployments that
                  upgrade from existing packages will recognize which operations
                  have been completed, executing only those that have been added
                  or changed.
                </p>
                <p className="mb-4">
              ...
              <div className="mb-8">
                ...
                <div className="mb-16" id="deployment-data">
                  ...
                  <p className="text-gray-400">
                    ...
                    made by defined steps in the cannonfile definition.
                    Deployment data is stored on IPFS and is locally stored in
              ...
              <div className="mb-8">
                ...
                <div className="mb-16" id="factory-deployed-contracts">
                  ...
                  <p className="mb-4">
                    ...
                    referred to as factory contracts. You can reference
                    contracts deployed by factories in your cannonfile.
                  </p>
                  ...
                  <div className="mb-4">
                    ...
                    <code className="block">
                      ...
                      not available in your artifacts, you can also reference
                      the ABI like:
                    </code>
                    <code className="block">
                  ...
                  <p className="mb-4">
                    ...
                    emit an event named NewDeployment with a contract address as
                    the first data argument (per arg, a zero-based index). This
                    contract should implement the Pool contract. Now, a
                    subsequent invoke operation could set target =
                    [&quot;MyPoolDeployment&quot;].
                  </p>

                  <p className="mb-4">
                    To reference contract information for a contract deployed on
                    a previous invoke operation such as the example shown above
                    call the contracts object inside your cannonfile. For
                    example &lt;%= contracts.MyPoolDeployment.address %&gt;
                  ...
                  <p className="mb-4">
                    ...
                    contracts object. &lt;%= contracts.MyPoolDeployment.address
                    %&gt; would return the first deployed Pool contract address.
                    &lt;%= contracts.MyPoolDeployment_0.address %&gt; would
                    return the second deployed Pool contract address. These
                ...
                <div className="mb-16" id="var">
                  <h3 className="text-lg mb-4">Use Event Data in a Variable</h3>
                  <p className="mb-4">
                    If an invoked function emits an event, cannon can parse the
                    event data in your cannonfile by using the var property,
