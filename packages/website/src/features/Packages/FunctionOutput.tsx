...
const resultText = (
  ...
  // if (name === 'pool' || name === 'startTime' || name === 'epochId') {
  //   console.log(`startTime or epochId or pool  --> ${name}`);
  //   console.log(value);
  // }
  ...
  const renderOutput = (
    ...
    if (
      ...
      return isArray(value)
        ...
        : null;
    } else if (abiParameter.type === 'address[]' && value) {
      return (
        <div>
          {(value as string[]).map((val, idx) => (
