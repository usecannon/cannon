...
export const IntegrationDiagram: FC = () => {
  ...
  nodes.push({ id: 'Your Smart Contract' });
  nodes.push({ id: 'Smart Account' });
  nodes.push({ id: 'Synthetix' });
  nodes.push({ id: 'USDC' });
  nodes.push({ id: 'Uniswap' });
  nodes.push({ id: 'Aave' });
  links.push({ source: 'Your Smart Contract', target: 'Smart Account' });
  links.push({ source: 'Your Smart Contract', target: 'Uniswap' });
  links.push({ source: 'Your Smart Contract', target: 'Aave' });
  links.push({ source: 'Smart Account', target: 'Synthetix' });
  links.push({ source: 'Uniswap', target: 'USDC' });
  links.push({ source: 'Aave', target: 'USDC' });
