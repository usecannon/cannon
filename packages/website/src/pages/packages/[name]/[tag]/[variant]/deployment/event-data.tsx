...
function generateMetadata({
  ...
  const title = `${params.name} on ${chain?.name} Event Data | Cannon`;

  const description = `Explore the Cannon package event data for ${
    params.name
...
EventData.getLayout = function getLayout(page: ReactElement) {
