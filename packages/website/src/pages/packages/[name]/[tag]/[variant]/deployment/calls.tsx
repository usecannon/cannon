...
function generateMetadata({
  ...
  const title = `${params.name} on ${chain?.name} Function Calls | Cannon`;

  const description = `Explore the Cannon package function calls for ${
    params.name
...
Calls.getLayout = function getLayout(page: ReactElement) {
