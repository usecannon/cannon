...
export const CodePreview: FC<ICodePreviewProps> = ({
  ...
  useEffect(() => {
    if (monaco) {
      // Should actually use https://github.com/microsoft/monaco-editor/tree/main/src/basic-languages/solidity
      // but will need something custom for toml? https://github.com/tamasfe/taplo/tree/master/editors/vscode
      monaco.languages.setMonarchTokensProvider('solidity', solidityDef);
    }
  }, [monaco]);
