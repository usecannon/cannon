...
export const TASK_ALTER = `${TASK_PREFIX}:alter`;
...
export const TASK_TEST = `${TASK_PREFIX}:test`;
...
export const SUBTASK_GET_ARTIFACT = `${TASK_PREFIX}:get-artifact`;
export const SUBTASK_RUN_ANVIL_NODE = `${TASK_PREFIX}:run-anvil-node`;
