...
contract MockAggregatorV2V3 is AggregatorV2V3Interface {
  ...
  // Mock setup function
  function setLatestAnswer(int256 answer, uint256 timestamp) public {
    roundId++;
  ...
  function setLatestAnswerCurrent(int256 answer) external {
    setLatestAnswer(answer, block.timestamp);
  }
