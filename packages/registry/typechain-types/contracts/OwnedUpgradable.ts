...
export interface OwnedUpgradableInterface extends utils.Interface {
  functions: {
...
export interface OwnedUpgradable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwnedUpgradableInterface;
