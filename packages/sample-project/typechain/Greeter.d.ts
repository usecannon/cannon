...
interface GreeterInterface extends ethers.utils.Interface {
  functions: {
    "doCloning()": FunctionFragment;
    "greet()": FunctionFragment;
    "greeting()": FunctionFragment;
    "setGreeting(string)": FunctionFragment;
  };

  encodeFunctionData(functionFragment: "doCloning", values?: undefined): string;
  encodeFunctionData(functionFragment: "greet", values?: undefined): string;
  encodeFunctionData(functionFragment: "greeting", values?: undefined): string;
  encodeFunctionData(functionFragment: "setGreeting", values: [string]): string;

  decodeFunctionResult(functionFragment: "doCloning", data: BytesLike): Result;
  ...
  events: {
    "NewClonedGreeter(address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "NewClonedGreeter"): EventFragment;
}

export type NewClonedGreeterEvent = TypedEvent<[string] & { cloned: string }>;
...
export class Greeter extends BaseContract {
  ...
  callStatic: {
    doCloning(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    "NewClonedGreeter(address)"(
      cloned?: null
    ): TypedEventFilter<[string], { cloned: string }>;
