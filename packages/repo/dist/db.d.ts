export declare const RKEY_FRESH_UPLOAD_HASHES = "repo:tempUploadHashes";
export declare const RKEY_PKG_HASHES = "repo:pkgHashes";
export declare const RKEY_EXTRA_HASHES = "repo:longTermHashes";
export declare function getDb(url: string): Promise<import("@redis/client").RedisClientType<{
    graph: {
