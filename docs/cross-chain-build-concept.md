...
This addresses the long-standing pain points around multi-chain deployments and bridge orchestration, Currently, users must manually manage multiple chains separately, leading to deployment fragmentation and inconsistent state.
...
chains = [1, 42161, 10, 8453, 137]  # mainnet, arbitrum, optimism, base, polygon
...
- Consider adding `--chain-id` flag to CLI for selective building
