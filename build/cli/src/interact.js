...
function printHeader(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const signerBalance = ctx.signer ? wei(yield ctx.signer.getBalance()) : wei(0);
        console.log('\n');
        console.log(gray('================================================================================'));
...
function pickContract({ contractNames }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { pickedContract } = yield prompts.prompt([
            {
                type: 'autocomplete',
                name: 'pickedContract',
...
function pickFunction({ contract }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        choices.unshift(PROMPT_BACK_OPTION);
        const { pickedFunction } = yield prompts.prompt([
            {
                type: 'autocomplete',
                name: 'pickedFunction',
...
function pickFunctionArgs({ func }) {
    return __awaiter(this, void 0, void 0, function* () {
        const args = [];
        let value = wei(0).toBN();
        if (func.payable) {
            const { txnValue } = yield prompts.prompt([
                {
                    type: 'number',
                    name: 'txnValue',
...
function execTxn({ contract, functionSignature, args, value, signer, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (signer != null) {
            const { confirmation } = yield prompts.prompt([
                {
                    type: 'confirm',
                    name: 'confirmation',
...
function promptInputValue(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < 5; i++) {
            try {
                const answer = yield prompts.prompt([
                    {
                        type: 'text',
                        message,
                        name,
...
function parseInput(input, rawValue) {
    ...
    if (requiresBytes32Util) {
        if (isArray) {
            processed = processed.map((item) => Ethers.utils.formatBytes32String(item));
        }
        else {
