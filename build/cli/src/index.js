...
program
    ...
    return __awaiter(this, void 0, void 0, function* () {
        yield checkCannonVersion(pkg.version);
    });
});
...
function configureRun(program) {
    return program
        ...
        .argument('[packageNames...]', 'List of packages to load, optionally with custom settings for each one', parsePackagesArguments)
        ...
        .option('--registry-ipfs-url [https://...]', 'URL of the JSON-RPC server used to query the registry', DEFAULT_REGISTRY_IPFS_ENDPOINT)
        .option('--registry-rpc-url [https://...]', 'Network endpoint for interacting with the registry', DEFAULT_REGISTRY_ENDPOINT)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const { run } = yield import('./commands/run');
...
program
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield execPromise(`forge build -c ${contractsPath} -o ${artifactsPath}`);
        const getArtifact = (name) => __awaiter(this, void 0, void 0, function* () {
            ...
            const artifactBuffer = yield fs.readFile(artifactPath);
...
program
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const { verify } = yield import('./commands/verify');
...
program
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const { packages } = yield import('./commands/packages');
...
program
    ...
    .action(function (packageName, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const { publish } = yield import('./commands/publish');
...
program
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const { importPackage } = yield import('./commands/import');
...
program
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const { exportPackage } = yield import('./commands/export');
