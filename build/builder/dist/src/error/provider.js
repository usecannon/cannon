...
exports.CannonWrapperJsonRpcProvider = void 0;
const ethers_1 = require("ethers");
const _1 = require(".");
class CannonWrapperJsonRpcProvider extends ethers_1.ethers.providers.JsonRpcProvider {
    constructor(artifacts, ...args) {
        super(...args);
        this.artifacts = artifacts;
        // construct second uninhibited instance
        this.passThroughProvider = new ethers_1.ethers.providers.JsonRpcProvider(...args);
    }
    waitForTransaction(transactionHash, confirmations, timeout) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw (0, _1.handleTxnError)(this.artifacts, this.passThroughProvider, err);
            }
        });
    }
...
exports.CannonWrapperJsonRpcProvider = CannonWrapperJsonRpcProvider;
