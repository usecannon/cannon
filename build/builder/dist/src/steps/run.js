...
exports.default = {
    ...
    exec(runtime, ctx, config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            outputs.contracts = lodash_1.default.mapValues(outputs.contracts, (c) => (Object.assign(Object.assign({}, c), { deployedOn: runtime.currentLabel })));
            outputs.txns = lodash_1.default.mapValues(outputs.txns, (t) => (Object.assign(Object.assign({}, t), { deployedOn: runtime.currentLabel })));
            return outputs;
        });
    },
};
