...
exports.ChainBuilder = exports.Events = void 0;
...
class ChainBuilder extends events_1.EventEmitter {
    constructor({ name, version, def, preset, readMode, writeMode, getSigner, getDefaultSigner, getArtifact, chainId, provider, baseDir, savedPackagesDir, }) {
        ...
        this.packagesDir = savedPackagesDir || (0, storage_1.getSavedPackagesDir)();
        this.packageDir = (0, storage_1.getPackageDir)(this.packagesDir, name, version);
        this.preset = preset !== null && preset !== void 0 ? preset : DEFAULT_PRESET;
        this.chainId = chainId;
        if (def) {
            this.def = def.allActionNames
                ? def
                : new definition_1.ChainDefinition(def);
        }
        else {
        ...
        this.getArtifact = getArtifact
            ? lodash_1.default.partial(util_1.passThroughArtifact, this.packageDir, getArtifact)
            : (name) => (0, util_1.getStoredArtifact)(this.packageDir, name);
    ...
    runStep(n, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let output;
            try {
                output = yield definition_1.ActionKinds[type].exec(this, ctx, cfg);
            }
            catch (err) {
                (0, error_1.handleTxnError)(ctx, this.provider, err);
...
previous txn deployed at: ${ctx.txns[txn].hash} in step ${'tbd'}`);
    ...
    findNextSteps(alreadyDone) {
        ...
        return lodash_1.default.filter(this.def.allActionNames.map((n) => [n, lodash_1.default.get(this.def, n)]), ([n, conf]) => !alreadyDone.has(n) && // step itself is not already done
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isCompleteLayer) {
                for (const action of layer.actions) {
                    let ctx = lodash_1.default.cloneDeep(baseCtx);
                    for (const dep of this.def.getDependencies(action)) {
                        ctx = (0, _1.combineCtx)([ctx, ctxes.get(dep)]);
                    }
            ...
            if (!isCompleteLayer) {
                ...
                for (const action of layer.actions) {
                    ...
                    const newCtx = yield this.runStep(action, lodash_1.default.clone(ctx));
...
${(0, util_1.printChainDefinitionProblems)(problems)}`);
            ...
            if (this.writeMode === 'all' || this.readMode === 'all') {
                ...
                for (const n of topologicalActions) {
                    ...
                    for (const dep of this.def.getDependencies(n)) {
                        ctx = (0, _1.combineCtx)([ctx, completed.get(dep)]);
                    }
            ...
            if (this.writeMode !== 'none') {
                yield (0, _1.putDeploymentInfo)(this.packageDir, this.chainId, this.preset, {
                    def: this.def.toJson(),
                    options: opts,
            ...
            if (this.writeMode === 'all' || this.writeMode === 'metadata') {
                ...
                return (0, _1.combineCtx)(Array.from(this.def.leaves).map((n) => completed.get(n)));
            }
        });
    }
    ...
    wipe() {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, _1.clearDeploymentInfo)(this.packageDir, this.chainId, this.preset);
        });
    }
    getDeploymentInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            const deployInfo = yield (0, _1.getDeploymentInfo)(this.packageDir, this.chainId, this.preset);
            if (deployInfo) {
    ...
    getOutputs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const h of deployInfo.heads) {
                ...
                const newCtx = yield this.loadMeta(lodash_1.default.last(h.split('/')));
                if (!newCtx) {
                    throw new Error('context not declared for published layer');
                }
                ctx = yield (0, _1.combineCtx)([ctx, newCtx]);
            }
            if (this.readMode === 'all') {
                // need to load state as well. the states that we want to load are the "leaf" layers
                const layers = lodash_1.default.uniq(Object.values(this.def.getStateLayers()));
    ...
    populateSettings(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.baseDir) {
                try {
                    pkg = yield fs_extra_1.default.readJson(path_1.default.join(this.baseDir, 'package.json'));
                }
                catch (_a) {
    ...
    layerMatches(ctx, stepName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const contents = yield fs_extra_1.default.readJson((0, storage_1.getActionFiles)(this.packageDir, ctx.chainId, this.preset, stepName).metadata);
    ...
    loadMeta(stepName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { metadata } = (0, storage_1.getActionFiles)(this.packageDir, this.chainId, this.preset, stepName);
    ...
    loadState(stepName) {
        return __awaiter(this, void 0, void 0, function* () {
            const { chain } = (0, storage_1.getActionFiles)(this.packageDir, this.chainId, this.preset, stepName);
    ...
    dumpAction(ctx, stepName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { metadata } = (0, storage_1.getActionFiles)(this.packageDir, ctx.chainId, this.preset, stepName);
    ...
    dumpState(stepNames) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const n of stepNames) {
                const { chain } = (0, storage_1.getActionFiles)(this.packageDir, this.chainId, this.preset, n);
    ...
    loadCannonfile() {
        const file = (0, _1.getDeploymentInfoFile)(this.packageDir);
        ...
        const rawDefinition = lodash_1.default.get(deployInfo.deploys, [this.chainId.toString(), this.preset, 'def'], deployInfo.def);
        return new definition_1.ChainDefinition(rawDefinition);
    }
    writeCannonfile() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.readMode !== 'none') {
                const file = (0, _1.getDeploymentInfoFile)(this.packageDir);
                const deployInfo = yield (0, _1.getAllDeploymentInfos)(this.packageDir);
                ...
                yield fs_extra_1.default.mkdirp(this.packageDir);
