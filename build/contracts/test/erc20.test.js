...
describe('Hardhat Runtime Environment', function () {
    ...
    before('load cannon node', function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.timeout(30000);
            yield hre.run(TASK_BUILD, { file: 'cannonfile.erc20.toml' });
            hre.run(TASK_CANNON, {
                label: 'erc20:0.0.1',
            });
    ...
    before('load module', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const content = yield readFile(resolve(hre.config.paths.deployments, hre.network.name, 'ERC20.json'));
    ...
    it('can interact with default token deployment', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            equal(Number(yield Token.totalSupply()), 0);
        });
    });
});
